export default function Candidate() {
    return (
        <div className="cell candidate-container" row="0">
            ...
            <div className="candidate" sub="5"></div>
            <div className="candidate" sub="6"></div>
            <div className="candidate" sub="7"></div>
            <div className="candidate" sub="8"></div>
            <div className="candidate" sub="9"></div>
        </div>
    );
}
